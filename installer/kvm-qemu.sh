...
function install_qemu() {
    ...
    if [ "$OS" = "Linux" ]; then
        ...
        apt-get update 2>/dev/null
        aptitude install -f python3-pip ninja-build libssh2-1-dev vde2 liblzo2-dev libghc-gtk3-dev libsnappy-dev libbz2-dev libxml2-dev google-perftools libgoogle-perftools-dev libvde-dev python3-sphinx-rtd-theme python3-tomli -y
